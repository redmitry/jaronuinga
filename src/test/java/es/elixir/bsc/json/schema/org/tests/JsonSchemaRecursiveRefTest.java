...
public class JsonSchemaRecursiveRefTest extends JsonSchemaOrgTest {
    
    private final static String JSON_DRAFT201909_TEST_FILE = "json-schema-org/tests/draft2019-09/recursiveRef.json";
